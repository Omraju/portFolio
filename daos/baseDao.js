import { getDb, getObjectId, toObjectId } from './MongodDbUtil.js';
...
/**
 *
 * @param {Object} projection - valid key values paires to project / show particular values form the collection of object
 * @param {Object} [options] - like transaction session object
...
async function get(id, projection = {}, options = {}) {
    ...
    try {
        options = Object.assign(options, { "projection": projection });
        let result = await collection.findOne({ _id: getObjectId(id) }, options);
        return Promise.resolve(result);
    }
    catch (e) {
        return Promise.reject(e);
...
async function update(id, operation, detail, options = {}) {
    ...
    try {
        ...
        let result = await collection.updateOne({ _id: getObjectId(id) }, detailToUpdate, options);
        return Promise.resolve(result);
    }
    catch (e) {
        return Promise.reject(e);
...
async function remove(id, options = {}) {
    ...
    let collection = db.collection(this.getCollectionName());
    try {
        let result = await collection.deleteOne({ _id: getObjectId(id) }, options);
        return Promise.resolve(result);
    }
    catch (e) {
        return Promise.reject(e);
...
export function base(collectionName) {
    return {
        aggregate: aggregate,
...
export function readOnly(collectionName) {
    return {
        aggregate: aggregate,
        basicPagination: basicPagination,
        limitedPagination: limitedPagination,
